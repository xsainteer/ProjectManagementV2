...
public class CreateFullProjectDtoValidator : AbstractValidator<CreateFullProjectDto>
{
    public CreateFullProjectDtoValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty().WithMessage("Project name is required")
            .MaximumLength(200).WithMessage("Project name cannot exceed 200 characters");
        ...
        RuleFor(x => x.ExecutorIds)
            .NotNull().WithMessage("Executor list cannot be null");
    }
}
